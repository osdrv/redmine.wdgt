...
RedmineWidget.prototype = {
  ...
  update: function() {
    info('updating...');
    var self = this;
    var _o = widget.system('curl "' + DOWNLOAD_NEW_VERSION_URL + '" > /tmp/redmine.wdgt.tar && cd /tmp/ && tar -xf redmine.wdgt.tar && rm redmine.wdgt.tar && cp -r redmine.wdgt ~/Library/Widgets/ && rm -r redmine.wdgt', 
      function() {
